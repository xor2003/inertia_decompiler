...
if TYPE_CHECKING or __package__:
    ...
    from .pytest_source_structure import PytestSourceIndex
else:
    from pytest_source_index import load_pytest_source_index
    from pytest_source_structure import PytestSourceIndex
...
TEST_OWNERSHIP_RULES: tuple[TestOwnershipRule, ...] = (
    ...
    TestOwnershipRule(
        owner="x86-16-caller-entry-identity",
        paths=(
        ...
        tests=(
            ...
            "angr_platforms/tests/test_x86_16_callsite_summary.py",
        ),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="acceptance-scorecard-reporting",
        paths=("inertia_decompiler/acceptance_scorecard.py",),
        tests=("angr_platforms/tests/test_acceptance_scorecard.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="sortd-generated-runtime",
        paths=(
            "scripts/check_sortd_generated_sort_core.py",
            "scripts/sortd_gp_runtime.py",
            "angr_platforms/tests/fixtures/sortd_generated_behavior_runtime.c",
            "angr_platforms/tests/fixtures/sortd_generated_sort_core_harness.c",
        ),
        tests=("angr_platforms/tests/test_sortd_generated_sort_core_gate.py",),
    ),
    TestOwnershipRule(
        owner="generated-translation-unit-compile",
        paths=("scripts/check_generated_translation_unit.py",),
        tests=("angr_platforms/tests/test_generated_translation_unit_gate.py",),
    ),
    TestOwnershipRule(
        owner="test-pipeline",
        paths=("scripts/check_sortd_sidecar_free.py", "scripts/sortd_function_gate.py", "scripts/test_pipeline.py"),
        tests=(
    ...
    TestOwnershipRule(
        owner="msc6-compat-headers",
        paths=("scripts/msc6_compat_headers.py", "scripts/compare_msc6_ssa_examples.py",
    ...
    TestOwnershipRule(
        ...
        paths=("angr_platforms/angr_platforms/X86_16/lowering/condition_operand_views.py",),
        tests=("angr_platforms/tests/test_x86_16_condition_operand_signedness.py",),
    ),
    TestOwnershipRule(
        owner="cod-stability-sweep",
        paths=("scripts/cod_stability_sweep.py",),
        tests=("angr_platforms/tests/test_cod_stability_sweep.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        ...
        tests=("angr_platforms/tests/test_direct_request_cache.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        ...
        tests=(
            ...
            "angr_platforms/tests/test_runtime_support_timing_guards.py",
        ),
    ),
    TestOwnershipRule(
        owner="pytest-decompiler-timeout-policy",
        paths=("Makefile",),
        tests=("angr_platforms/tests/test_x86_16_timeout_support.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="function-graph-coherence",
        paths=("inertia_decompiler/cli_function_discovery.py", "inertia_decompiler/function_graph_extent_repair.py"),
        tests=("angr_platforms/tests/test_x86_16_function_graph_extent_repair.py",),
    ),
    TestOwnershipRule(
        owner="return-value-provenance-transport",
        paths=(
            "angr_platforms/angr_platforms/X86_16/compat.py",
            "angr_platforms/angr_platforms/X86_16/lowering/codegen_return_origin.py",
        ),
        tests=("angr_platforms/tests/test_x86_16_codegen_return_origin.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        ...
        tests=("angr_platforms/tests/test_recompile_check.py", "angr_platforms/tests/test_missing_dos_toolchain.py"),
    ),
    TestOwnershipRule(
        owner="pklite-native-decoder",
        paths=("angr_platforms/angr_platforms/X86_16/pklite.py", "inertia_decompiler/external_unpacker_cache.py"),
        tests=("angr_platforms/tests/test_x86_16_pklite.py",),
    ),
    TestOwnershipRule(
        owner="catalog-budget",
        paths=("inertia_decompiler/catalog_policy.py", "inertia_decompiler/cli_arg_parser.py"),
        tests=("angr_platforms/tests/test_cli_catalog_budget.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="x86-16-tagged-subtree-projection",
        paths=(
            "angr_platforms/angr_platforms/X86_16/structuring/tagged_subtree_projection.py",
        ),
        tests=("angr_platforms/tests/test_x86_16_tagged_subtree_projection.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(owner="x86-16-semantics-evidence-cache",
    ...
    TestOwnershipRule(owner="x86-16-semantics-expression-analysis",
    ...
    TestOwnershipRule(owner="x86-16-semantics-alias-query",
    ...
    TestOwnershipRule(owner="x86-16-semantics-alu",
    ...
    TestOwnershipRule(owner="x86-16-lowering-stack-probe-return-facts",
        paths=("angr_platforms/angr_platforms/X86_16/lowering/stack_probe_return_facts.py",),
        tests=("angr_platforms/tests/test_x86_16_stack_lowering_contracts.py",),
    ),
    TestOwnershipRule(owner="x86-16-lowering-ss-bp-substitution",
        paths=("angr_platforms/angr_platforms/X86_16/lowering/ss_bp_substitution.py",),
        tests=("angr_platforms/tests/test_x86_16_stack_lowering_contracts.py",),
    ),
    TestOwnershipRule(owner="x86-16-lowering-object-lowering",
    ...
    TestOwnershipRule(owner="x86-16-ir-readiness",
    ...
    TestOwnershipRule(
        owner="x86-16-alias-condition-register-source-bindings",
        paths=(
    ...
    TestOwnershipRule(
        owner="x86-16-authoritative-function-prototypes",
        paths=(
        ...
        tests=(
            "angr_platforms/tests/test_x86_16_authoritative_function_prototypes.py",
            "angr_platforms/tests/test_x86_16_near_return_address_arguments.py",
        ),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="x86-16-register-local-declarations",
        paths=(
    ...
    TestOwnershipRule(
        owner="x86-16-structured-ast-query-index",
        paths=(
    ...
    TestOwnershipRule(
        owner="x86-16-pipeline-result-contracts",
        paths=(
            "angr_platforms/angr_platforms/X86_16/pipeline/result_contracts.py",
        ),
        tests=("angr_platforms/tests/test_x86_16_pipeline_result_contracts.py",),
    ),
    TestOwnershipRule(
        owner="x86-16-postprocess-validation-policy",
        paths=(
        ...
        tests=("angr_platforms/tests/test_x86_16_postprocess_validation_policy.py",),
    ),
    TestOwnershipRule(
        owner="x86-16-postprocess-rollback-snapshot-cache",
        paths=(
            "angr_platforms/angr_platforms/X86_16/postprocess/rollback_snapshot_cache.py",
        ),
        tests=("angr_platforms/tests/test_x86_16_postprocess_rollback_snapshot_cache.py",),
    ),
    TestOwnershipRule(
        owner="x86-16-control-flow-ast-index",
        paths=(
    ...
    TestOwnershipRule(
        owner="x86-16-stack-address-coordinates",
        paths=(
    ...
    TestOwnershipRule(
        owner="x86-16-stack-storage-evidence",
        paths=(
        ...
        tests=(
            ...
            "angr_platforms/tests/test_x86_16_segmented_stack_alias.py",
        ),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="x86-16-instruction-origin",
        paths=(
        ...
        tests=("angr_platforms/tests/test_x86_16_ir_instruction_origin.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="x86-16-frontend-function-boundaries",
        paths=(
    ...
    TestOwnershipRule(
        owner="x86-16-ir-condition-sign-extension",
        paths=(
    ...
    TestOwnershipRule(
        owner="insertionsort-generated-c-oracle",
        paths=("angr_platforms/tests/x86_16_insertionsort_behavior.py",),
        tests=("angr_platforms/tests/test_x86_16_insertionsort_behavior.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="swapbars-generated-c-oracle",
        paths=("angr_platforms/tests/x86_16_swapbars_behavior.py",),
        tests=("angr_platforms/tests/test_x86_16_swapbars_behavior.py",),
    ),
    TestOwnershipRule(
        owner="coherent-gp-word-runtime",
        paths=(
    ...
    TestOwnershipRule(
        owner="aggregate-byte-projection",
        paths=(
        ...
        tests=(
            ...
            "test_sortd_insertionsort_sidecar_free_splits_header_and_rebases_source",
        ),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(
        owner="x86-16-return-liveness-replay",
        paths=(
            "angr_platforms/angr_platforms/X86_16/lowering/return_liveness_replay.py",
        ),
        tests=("angr_platforms/tests/test_x86_16_return_liveness_replay.py",),
    ),
    TestOwnershipRule(
    ...
    TestOwnershipRule(owner="x86-16-ir-logical-memory",
        paths=("angr_platforms/angr_platforms/X86_16/access.py",
            "angr_platforms/angr_platforms/X86_16/lift_86_16.py",
        ...
        tests=("angr_platforms/tests/test_x86_16_semantics_evidence_cache.py",
            "angr_platforms/tests/test_x86_16_access.py",
            "angr_platforms/tests/test_x86_16_vex_import.py",
            "angr_platforms/tests/test_x86_16_vex_memory_access_fidelity.py",
            "angr_platforms/tests/test_x86_16_interprocedural_storage_return_pointer_stack.py",
    ...
    TestOwnershipRule(
        ...
        paths=("angr_platforms/angr_platforms/X86_16/alias/terminal_memory_outputs.py",),
        tests=(
    ...
    TestOwnershipRule(
        ...
        paths=("angr_platforms/angr_platforms/X86_16/widening/terminal_memory_output_views.py",),
        tests=(
    ...
    TestOwnershipRule(
        owner="x86-16-terminal-pointer-output-semantics",
        paths=(
    ...
    TestOwnershipRule(
        owner="x86-16-terminal-pointer-output-widening",
        paths=(
